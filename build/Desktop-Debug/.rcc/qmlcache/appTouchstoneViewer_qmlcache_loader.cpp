...
namespace _0x5f_TouchstoneViewer_src_ui_Main_qml { 
...
int QT_MANGLE_NAMESPACE(qInitResources_qmlcache_appTouchstoneViewer)() {
    ::unitRegistry();
    return 1;
}
Q_CONSTRUCTOR_FUNCTION(QT_MANGLE_NAMESPACE(qInitResources_qmlcache_appTouchstoneViewer))
int QT_MANGLE_NAMESPACE(qCleanupResources_qmlcache_appTouchstoneViewer)() {
    return 1;
}
